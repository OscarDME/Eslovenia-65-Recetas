...
export const copy = {
  metadata: {
    title: "1000 zdravih receptov — Brez sladkorja in glutena",
    description:
  ...
  hero: {
    ...
    trustChips: [
      ...
      { icon: "🛡️", text: "Danes več kot 75 % popusta" },
    ],
  },
  ...
  story: {
    ...
    problems: [
      ...
      "Pospešeno staranje",
      "Odvisnost od hrane in nenehna lakota",
    ],
    solutionHeadline:
  ...
  benefits: {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "Naučite se zavestno izbirati hrano in zgradite zdrave navabe za vse življenje.",
      },
      {
        icon: "Scale",
  ...
  finalCta: {
    ...
    subUrgency:
      "Ne zamudite priložnosti, da si zagotovite knjigo receptov z več kot 75-odstotnim popustom. Preoblikujte svoje zdravje zdaj z našim popolnim jedilnikom za 365 dni.",
    ...
    discountBadge: "VEČ KOT 75 % POPUSTA",
  ...
  faq: {
    ...
    items: [
      { q: "KAKO BOM PREJEL/A RECEPTE?", a: "Vso vsebino boste prejeli na svoj e-poštni naslov takoj po plačilu." },
      { q: "ALI LAHKO DOSTOPAM PREK TELEFONA?", a: "Da, do receptov lahko dostopate prek telefona, tablice ali računalnika." },
  ...
  footer: {
    brand: "Crearis",
    copyright: "2026 © Vse pravice pridržane. Preberite našo Politiko zasebnosti.",
  },
};